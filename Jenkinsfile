...
pipeline {
    ...
    environment {
        ...
        IMAGE_TAG = "v2.0.0-${BUILD_NUMBER}"    // or use BRANCH_NAME if you split pipelines
    ...
    stages {
        ...
        stage('Checkout Code') {
            steps {
                git branch: 'release/v2.0.0', url: 'https://github.com/Sayantan2k24/spring-boot-crud-mysql-k8s-example02.git'
            }
        }
